...
1. Within this subfolder, open the GrandCanyonInterveningFlow.Rproject file.
1. Select the GrandCanyonTribFlow.Rmd tab (R markdown file).
1. Just below, click the **Knit** button.
