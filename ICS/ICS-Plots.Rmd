...
4. A bar plot shows the ratio of the ICS withdrawal limit to the DCP obligation at two different Lake Mead water levels. If ICS withdrawal limits are enforced, this ratio represents the fraction of the DCP contribution the state could make from it's ICS account each year. This ratio assumes there is sufficient water in the ICS account.
