...
**Can flex accounting encourage more water conservation in the Colorado River basin?** Follow the directions below to download and try out the flex water accounting tool by yourself or with colleagues, friends, or family.
 ...
 * Rows represent the components of the combined water budget for Lake Powell-Lake Mead system.
 * Columns represent years.
 * Cell fill indicates the type of decision:
   * Physical watershed data (such as inflows and reservoir evaporation)
   * Political (player) decisions (such as individual water consumption and conservation),
   * Calculations, and
   * Facilitation steps.
...
## Directions to Use
1. Download the file **PilotFlexAccounting-CombinedPowellMead.xlsx** to your computer.
...
1. **PilotFlexAccounting-CombinedPowellMead.xlsx** - An Excel file with the pilot flex accounting tool and directions for the role play. For syncronous access by multiple players, download and move this file into a Google Sheet. See the ReadMe-Directions worksheet for directions.
